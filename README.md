...
> **Форк** оригинального [WalkingMeatAxolotl/AnimaLoraStudio](https://github.com/WalkingMeatAxolotl/AnimaLoraStudio) (база 0.12.0 + бэкпорты избранных фич из новых версий апстрима).
