...
> **Fork** of the original [WalkingMeatAxolotl/AnimaLoraStudio](https://github.com/WalkingMeatAxolotl/AnimaLoraStudio) (based on 0.12.0, with selected features backported from newer upstream releases).
